...
class Game:
    ...
    def __init__(self, players, cols=9, rows=9, totalFenceCount=20, squareSize=32, innerSize=None):
        ...
        pygame.mixer.init()
        self.move_sound = pygame.mixer.Sound("move.wav")  # Replace with actual sound file
        self.fence_sound = pygame.mixer.Sound("fence.wav")  # Replace with actual sound file
        self.win_sound = pygame.mixer.Sound("win.wav")  # Replace with actual sound file
        ...
        for roundNumber in range(1, roundCount + 1):
            ...
            while not finished:
                ...
                if isinstance(action, PawnMove):
                    ...
                    self.fence_sound.play()  # Play fence sound
